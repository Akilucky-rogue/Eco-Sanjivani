...
export const translations: Record<Language, Translations> = {
  en: {
    ...
    home: {
      ...
      heroTitle: "Protect India's Diverse Ecosystems",
      heroSubtitle:
        "Join thousands of volunteers in gamified conservation efforts to restore our forests, wetlands, coastal areas, and urban environments.",
  ...
  hi: {
    ...
    home: {
      title: "इको-संजीवनी",
      subtitle: "पर्यावरण संरक्षण मंच",
      heroTitle: "भारत के विविध पारिस्थितिकी तंत्रों की रक्षा करें",
      heroSubtitle:
        "हमारे महासागर, जलीय क्षेत्र, तटीय क्षेत्र और शहरी पर्यावरणों को बहाल करने के लिए गेमिफाइड संरक्षण प्रयासों में हजारों स्वयंसेवकों के साथ जुड़ें।",
  ...
  mr: {
    ...
    home: {
      title: "इको-संजीवनी",
      subtitle: "पर्यावरण संरक्षण व्यासपीठ",
      heroTitle: "भारताच्या विविध पारिस्थितिकी तंत्रांची रक्षा करा",
      heroSubtitle:
        "आमच्या महासागर, जलीय क्षेत्र, तटीय क्षेत्र आणि शहरी पर्यावरणांच्या पुनर्वसनासाठी गेमिफाइड संरक्षण प्रयत्नांमध्ये हजारो स्वयंसेवकांसोबत सामील व्हा.",
  ...
  gu: {
    ...
    home: {
      title: "ઇકો-સંજીવની",
      subtitle: "પર્યાવરણ સંરક્ષણ પ્લેટફોર્મ",
      heroTitle: "ભારતના વિવિધ પારિસ્થિતિકી તંત્રોનું રક્ષણ કરો",
      heroSubtitle:
        "અમારા મહાસાગરો, જલીય ક્ષેત્રો, તટીય ક્ષેત્રો અને શહરી પર્યાવરણોને પુનઃસ્થાપિત કરવા માટે ગેમિફાઇડ સંરક્ષણ પ્રયાસોમાં હજારો સ્વયંસેવકો સાથે જોડાઓ.",
  ...
  ta: {
    ...
    home: {
      title: "ஈகோ-சஞ்சீவனி",
      subtitle: "பருவரண பாதுகாப்பு தளம்",
      heroTitle: "இந்தியாவின் வெவ்வேறு பருவரண அமைப்புகளைப் பாதுகாக்கவும்",
      heroSubtitle:
        "எங்கள் கடல்கள், வெட்டல்கள், கடலோர பகுதிகள் மற்றும் நகர பருவரணங்களை மீட்டெடுக்க கேமிஃபைட் பாதுகாப்பு முயற்சிகளில் ஆயிரக்கணக்கான தன்னார்வலர்களுடன் சேரவும்.",
  ...
  te: {
    ...
    home: {
      title: "ఈకో-సంజీవని",
      subtitle: "పరిరక్షణ వేదిక",
      heroTitle: "భారతదేశ వివిధ పరిరక్షణ అమైనాలను రక్షించండి",
      heroSubtitle:
        "మా మహాసముద్రాలు, వెడ్డలు, తీర ప్రాంతాలు మరియు నగర పరిరక్షణ అమైనాలను పునరుద్ధరించడానికి గేమిఫైడ్ పరిరక్షణ ప్రయత్నాలలో వేలాది మంది వాలంటీర్లతో చేరండి.",
  ...
  kn: {
    ...
    home: {
      ...
      heroTitle: "ಭಾರತದ ವಿವಿಧ ಪರಿಸರ ವ್ಯವಸ್ಥೆಗಳನ್ನು ರಕ್ಷಿಸಿ",
      heroSubtitle:
        "ನಮ್ಮ ಸಾಗರಗಳು, ಜಲೀಯ ಪ್ರದೇಶಗಳು, ಕರಾವಳಿ ಪ್ರದೇಶಗಳು ಮತ್ತು ನಗರ ಪರಿಸರ ವ್ಯವಸ್ಥೆಗಳನ್ನು ಪುನಃಸ್ಥಾಪಿಸಲು ಗೇಮಿಫೈಡ್ ಸಂರಕ್ಷಣಾ ಪ್ರಯತ್ನಗಳಲ್ಲಿ ಸಾವಿರಾರು ಸ್ವಯಂಸೇವಕರೊಂದಿಗೆ ಸೇರಿ.",
  ...
  ml: {
    ...
    home: {
      ...
      subtitle: "സമുದ്ര സംരക്ഷണ പ്ലാറ്റ്‌ഫോം",
      heroTitle: "ഇന്ത്യയുടെ വിവിധ പരിസര വ്യവസ്ഥകളെ സംരക്ഷിക്കുക",
      heroSubtitle:
        "നമ്മുടെ സമുദ്രങ്ങളും, ജലീയ പ്രദേശങ്ങളും, തീരപ്രദേശങ്ങളും മತ്തു നഗര പരിസര വ്യവസ്ഥകളും പുനഃസ്ഥാപിക്കാൻ ഗെയിമിഫൈഡ് സംരക്ഷണ ശ്രമങ്ങളിൽ ആയിരക്കണക്കിന് സന്നദ്ധപ്രവർത്തകരോടൊപ്പം ചേരുക.",
    ...
    impact: {
      ...
      marineLifeProtected: "സംരക്ഷിത സമുদ്രജീവികൾ",
  ...
  bn: {
    ...
    home: {
      title: "ইকো-সঞ্জীবনী",
      subtitle: "পরিবেশ সংরক্ষণ প্ল্যাটফর্ম",
      heroTitle: "ভারতের বিভিন্ন পরিবেশ অনুযায়ী রক্ষা করুন",
      heroSubtitle:
        "আমাদের সমুদ্র, জলীয় অঞ্চল, উপকূলীয় অঞ্চল এবং শহরী পরিবেশ পুনরুদ্ধারের জন্য গেমিফাইড সংরক্ষণ প্রচেষ্টায় হাজার হাজার স্বেচ্ছাসেবকদের সাথে যোগ দিন।",
